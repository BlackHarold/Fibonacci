package home.blackharold.graphics;
...
class DisplayModeModel extends DefaultTableModel {
    ...
    public String getColumnName(int c) {
        return FullScreenDisplay.COLUMN_NAMES[c];
    }

    public int getColumnCount() {
        return FullScreenDisplay.COLUMN_WIDTHS.length;
    }
    ...
    public Object getValueAt(int rowIndex, int colIndex) {
        ...
        switch (colIndex) {
            case FullScreenDisplay.INDEX_WIDTH :
                return Integer.toString(dm.getWidth());
            case FullScreenDisplay.INDEX_HEIGHT :
                return Integer.toString(dm.getHeight());
            case FullScreenDisplay.INDEX_BITDEPTH : {
            ...
            case FullScreenDisplay.INDEX_REFRESHRATE : {
...
public class FullScreenDisplay extends JFrame implements ActionListener,
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1 /* devices.length */; i++) {
            FullScreenDisplay test = new FullScreenDisplay(devices[i]);
