 ...
 * Main frame class.
 */
public class FullScreenTest extends JFrame implements ItemListener {
    ...
    public FullScreenTest(GraphicsDevice dev) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < devices.length; i++) {
            FullScreenTest tst = new FullScreenTest(devices[i]);
            tst.pack();
            tst.setVisible(true);
        }
    }
