...
public class BlackBackground {
	...
	private static Color[] COLORS = new Color[] {
	    ...
	    public BlackBackground(int numBuffers, GraphicsDevice device) {
	        try {
	    ...
	    public static void main(String[] args) {
	        try {
	            ...
	            System.out.println(device.getDisplayModes());
	            BlackBackground test = new BlackBackground(numBuffers, device);
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
	        System.exit(0);
